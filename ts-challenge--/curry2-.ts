...
> = Props extends [infer First]
  ...
  ? ((...args: [...Args, First]) => Currying<Rest, Return>) &
      Currying<Rest, Return, [...Args, First]>
  : () => Return;

declare function DynamicParamsCurrying<Props extends unknown[], Return>(
  fn: (...args: Props) => Return
): Currying<Props, Return>;
